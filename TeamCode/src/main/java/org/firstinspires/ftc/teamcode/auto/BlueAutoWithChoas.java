...
import static org.firstinspires.ftc.teamcode.auto.paths.back2start;
import static org.firstinspires.ftc.teamcode.auto.paths.start2park;
...
@Autonomous(name = "BlueWithChoas", group = "4848")
public final class BlueAutoWithChoas extends LinearOpMode {
            ...
            switch (State){
                ...
                case shooting1:
                    if(robot.stateTime.seconds() >= 4){
                        ...
                        robot.drive.followPath(back2start,true);
                ...
                case ShootPosetoIntake1:
                    if(!robot.drive.isBusy() && robot.stateTime.seconds() >= 15) {
                        ...
                        robot.drive.followPath(start2park,true);
                    }
                    break;
