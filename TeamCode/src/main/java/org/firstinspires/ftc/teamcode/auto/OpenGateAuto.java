...
import static org.firstinspires.ftc.teamcode.auto.paths.OpenGate;
...
@Autonomous(name = "OpenGateAuto", group = "4848")
public final class OpenGateAuto extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (State){
                ...
                case shooting2:
                    ...
                    if(robot.stateTime.seconds() > 6.5){
                        // stop firing
                        robot.intake.setPower(0);
                        robot.spanker.setPosition(.65);
                        if(!robot.drive.isBusy()){
